...
},
{
  ...
  answerText: "I remember encountering this animal before, and I'm sure that she remembers me too! An African Elephant has an exceptional memory after all! Lets take a picture and leave her to catch up with her herd. \n Let's choose another country to visit!",
  image: "http://www.pngall.com/wp-content/uploads/2016/06/Elephant-PNG.png",
finishingText: "We've found an African Elephant! Did you know that elephants are some of the largest land animals on the entire planet? \n The African Elephant uses its long trunk to pick up water, then it sprays the water into its mouth for a drink. \n If the Elephant isn't thirsty, it can also use it's trunk as a large hose, and will cool itself off with the spray of water. Let us take a picture of her and leave her to catch up with her heard. \n Choose another country to visit!",
...
},
{
  ...
  finishingText: "We've found ourselves a Snow Leopard! This big cat spends its entire life high up in the mountains, about 9'800 - 17'000 feet up. \n Up here the air is so thin that this big cat has to breathe deep to get enough air to survive. \n When hunting, a snow leopard can jump around 9 metres, that's almost the length of a bus! Let's take a picture and leave her in peace to go and hunt. \n Choose another country to visit!",
...
},
{
  ...
  questions: {
    ...
    three: "This cat will sometimes be seen climbing a tree so as to leap down onto its prey."
  },
  answerText:"I remember seeing this animal on a trip into the forest once, it's a Jaguar! This big cat lives mostly alone, roaming around its territory. When it roars it sounds almost like a chesty cough. I've taken a picture, so we can leave him to sleep.  \n Let's choose another country to visit!",
  image: "http://www.pngall.com/wp-content/uploads/2016/04/Jaguar-PNG-Picture.png",
  finishingText: "We've found ourselves a Jaguar! This big cat lives mostly alone, roaming through its territory. It has powerful jaws which it uses to bite through the skulls of most of the animals which are to become its prey. \n The Jaguar can live in a variety of habitats, from the forests and rainforests to the swamps and grasslands. \n Normally the jaguar has a yellow and tan coat, however they can have much darker coats as well, almost black in some instances. \n This cat looks tired, lets take a picture so he can get some sleep. \n Choose another country to visit!",
